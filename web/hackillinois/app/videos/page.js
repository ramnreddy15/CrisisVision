    ...
    <div classname='w-screen bg-[#252422]'>
      ...
      <div className="text-black h-[2000px] bg-[#252422]">
        ...
        <div className="relative h-full w-[85%] left-[7.5%] top-[200px] flex flex-col justfiy-center gap-[110px]">
          ...
          <iframe width="560" height="315" src="https://www.youtube.com/embed/H-ocT0HjJQU?si=CBe_Ahsv0VghIHRS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
